...
private WPI_VictorSPX _backLeft = new WPI_VictorSPX(4);
private WPI_VictorSPX _frontLeft = new WPI_VictorSPX(1);
private WPI_VictorSPX _backRight = new WPI_VictorSPX(3);
private WPI_VictorSPX _frontRight = new WPI_VictorSPX(2);
